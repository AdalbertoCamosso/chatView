  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-[4px] text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-destructive rounded-sm  text-destructive-foreground shadow-sm hover:bg-destructive/90",
        outline:
          "border rounded-sm  border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-secondary rounded-sm  text-secondary-foreground shadow-sm hover:bg-secondary/80",
